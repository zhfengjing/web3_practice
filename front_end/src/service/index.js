...
const getAccounts = () => request('/wallets', {}, 'get');
...
export { createAccount, getAccounts, transferAccounts, mine, pendingTransactions, getBalanceOfAddress, validChain, getBlocks, getPendingTransactions }